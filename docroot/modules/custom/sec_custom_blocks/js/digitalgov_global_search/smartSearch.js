...
(function (){
    ...
    function enableSmartSearchEntitySuggestions() {
        ...
        hintsContainer.id = "smart-search-container";
        hintsContainer.innerHTML = '<div class="smart-search-entity-hints">' +
            '<span class="smart-search-EDGAR">EDGAR</span><span class="smart-search-resources">| Filings</span><br />' +
            '<table class="smart-search-entity-hints" width="450"></table>' +
            '<br /><a class="smart-search-edgar-full-text" href="#">Search for &quot;<span class="smart-search-search-text"></span>&quot; in EDGAR filings</a><br />' +
            '<span class="smart-search-SEC-gov">SEC.gov</span><span class="smart-search-resources">| Webpages &amp; Documents</span><br />' +
        ...
        hintsContainer.querySelector('div.smart-search-sec-gov-website').addEventListener('click', function searchSecGov(){
            var searchContainer = hintsContainer.parentElement.parentElement;
        ...
        if(globalSearchBox) {
            ...
            var searchContainer = globalSearchBox.parentElement.parentElement;
        }
                ...
                request.onload = function() {
                    if (this.status >= 200 && this.status < 400 && keysTyped==control.value) {
                        if(activeInputBoxID != control.id){
                            searchContainer = control.parentElement.parentElement;
