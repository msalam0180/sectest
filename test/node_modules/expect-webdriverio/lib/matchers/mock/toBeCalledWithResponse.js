...
exports.toBeCalledWithResponse = void 0;
const utils_1 = require("../../utils");
const expectAdapter_1 = require("../../util/expectAdapter");
const jasmineUtils_1 = require("../../jasmineUtils");
function toBeCalledWithResponseFn(received, response, options = {}) {
...
function toBeCalledWithResponse(...args) {
    return expectAdapter_1.runExpect.call(this, toBeCalledWithResponseFn, args);
}
exports.toBeCalledWithResponse = toBeCalledWithResponse;
