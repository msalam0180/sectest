...
exports.config = {
  ...
  services: [
    ...
    ['image-comparison',
      // The options
      {
        ...
        baselineFolder: join(process.cwd(), './baseline_ss/'),
        formatImageName: '{width}x{height}/{logName}{tag}',
  ...
  before: function before() {
    // global.TimelineReporter = require('/node_modules/wdio-timeline-reporter').default;
