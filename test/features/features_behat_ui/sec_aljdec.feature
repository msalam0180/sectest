...
Scenario: ALJ Initial Devisions Pages Screenshot
  Given "customized_comment_form" content:
    ...
    And "release" content:
      ...
      | Test  | ALJ Initial Decisions | Note                  | 2-12312, 1-32, 4-523 | published        | 2021-02-02 12:00:00 | 1      | Frank             | Behat External, Behat Internal | Comment behat         |
  Then I take a screenshot on "sec" using "aljdec.feature" file with "@aljdeclist" tag
    And I take a screenshot on "sec" using "aljdec.feature" file with "@aljdecnode " tag
