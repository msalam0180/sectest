...
Scenario: Stop Orders Pages Screenshot
  Given "customized_comment_form" content:
    ...
    And "release" content:
      ...
      | Test  | Stop Orders        | Note                  | 2-12312, 1-32, 4-523 | published        | 2021-02-02 12:00:00 | 1      | Frank             | Behat External, Behat Internal | Comment behat         |
  Then I take a screenshot on "sec" using "orders.feature" file with "@stoporderslist" tag
    And I take a screenshot on "sec" using "orders.feature" file with "@stopordersnode " tag
